...
function App() {
  ...
  useEffect(() => {
    axios.get("https://api.github.com/users/Hassanlafole").then((res) => {
  ...
  useEffect(() => {
    axios.get("https://api.github.com/users/Hassanlafole/followers").then((res) => {
  ...
  useEffect(() => {
    axios.get("https://api.github.com/users/Hassanlafole/following").then((res) => {
